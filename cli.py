...
def main():
    ...
    parser.add_argument("--symbol", type=str, required=True, help="Trading Pair")
    ...
    parser.add_argument("--quantity", type=float, required=True, help="Quantity")
    parser.add_argument("--price", type=float, default=None, help="Price")
